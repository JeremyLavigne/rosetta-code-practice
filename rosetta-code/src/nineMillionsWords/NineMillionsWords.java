...
public class NineMillionsWords {
	...
	public static void solveProblem() {
		...
		//List<String> integer6names = findAllNames(6);
		//List<String> integer7names = findAllNames(7);
		
		// Recursive option is obviously not optimal, computer doesn't like as soon as we ask bigger numbers.. 
		...
		//List<String> integer123names = findAllNames(123);
		...
		//System.out.println("The integer 6 has " + integer6names.size() + " names : " + integer6names.toString());
		//System.out.println("The integer 7 has " + integer7names.size() + " names : " + integer7names.toString());
		//System.out.println("The integer 23 has " + integer23names.size() + " names : " + integer23names.toString());
		//System.out.println("The integer 123 has " + integer123names.size() + " names : " + integer123names.toString());
